...
public class MovieSeriesAdapter extends RecyclerView.Adapter<MovieSeriesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.genre.setTextSize(TypedValue.COMPLEX_UNIT_DIP,14);
        holder.genre.setTypeface( holder.genre.getTypeface(), Typeface.BOLD);
        //holder.genre.setTextColor(Color.parseColor("#FF404040"));
