...
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.adapter.CastAdapter;
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.adapter.SectionListDataAdapter;
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.bo.MovieDetailsBO;
...
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.adapter.DownloadMovieAdapter;
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.app.AppController;
import com.dipanjan.app.ytsyifyhdmovietorrentdownloader.helper.FileDownloder;
...
public class MovieDeatils extends AppCompatActivity {
    ...
    private Movie movie;
    private RelativeLayout similarMovieLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        similarMovieLayout = (RelativeLayout)findViewById(R.id.similarMoviesLayout);
       ...
       //commenting out this portion for Movie Series App
       ...
       // Toast.makeText(getApplicationContext(),"come here "+URL_END_POINT+getMovieIDFromActivity(),Toast.LENGTH_SHORT).show();
        ...
        learn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IMDB_CODE_MOVIE != null) {
                    AppController.getInstance().logEventForFirebase(Constant.AnalyticsTags.CATEGORY_BUTTON_CLICK,"Click on Learn More","");
        ...
        imdblink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (IMDB_CODE_MOVIE != null) {
                    AppController.getInstance().logEventForFirebase(Constant.AnalyticsTags.CATEGORY_BUTTON_CLICK,"Click on Movie IMDB LINK","");
                    new FinestWebView.Builder(getApplicationContext()).theme(R.style.FinestWebViewTheme)
                            .titleDefault("Loading..")
                            .toolbarScrollFlags(0)
                            .statusBarColorRes(R.color.blackPrimaryDark)
        ...
        watchTrailer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(movieTrailerCode!=null){
                    AppController.getInstance().logEventForFirebase(Constant.AnalyticsTags.CATEGORY_BUTTON_CLICK,"Click on Watch Trailer","");
               ...
               // Log.e(TAG, "click " + checked);
                if(checked){
                    ...
                    if(flag){
                        ...
                        AppController.getInstance().logEventForFirebase(Constant.AnalyticsTags.CATEGORY_MOVIE_LIKE_CLICK,"Click on MOVIE LIKE","");
                    }else{
                    ...
                    if(flag){
                        ...
                        AppController.getInstance().logEventForFirebase(Constant.AnalyticsTags.CATEGORY_DISMOVIE_LIKE_CLICK,"Click on MOVIE DISLIKE","");
                    }else{
                        shineButton.setBtnColor(Color.RED);
